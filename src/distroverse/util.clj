...
(let
   [public Opcodes/ACC_PUBLIC
    ...
    lload Opcodes/LLOAD
    iload Opcodes/ILOAD
    cname-slash "distroverse/util/RawOps"
    cname-dot   "distroverse.util.RawOps"
    rawops-bytecode
    (let [cw (ClassWriter. 0)]
      (.visit cw Opcodes/V1_5 (+ public Opcodes/ACC_SUPER)
              cname-slash nil "java/lang/Object" nil)
      ...
      (.visitEnd cw)
      (.toByteArray cw))]
  (.defineClass @clojure.lang.Compiler/LOADER cname-dot rawops-bytecode
                nil))
